...
/*		GroupBuilder gb2 = new GroupBuilder(); 
	...
	public void createPieChart(AbstractColumn pc, List<AbstractColumn> aa, DynamicReportBuilder drb){
		DJChart djChart = new DJPieChartBuilder()
		//chart		
		.setX(20)
		.setY(10)
	...
	/*public void testChart() {
		...
		assertEquals(new Byte(DJChartOptions.EDGE_BOTTOM), chart.getLegendPositionValue());
		assertEquals(new Byte(DJChartOptions.EDGE_TOP), chart.getTitlePositionValue());
	...
	public static void main(String[] args) throws Exception {
		PieChartBuilder test = new PieChartBuilder();
		test.setUp();
		//test.testReport();
