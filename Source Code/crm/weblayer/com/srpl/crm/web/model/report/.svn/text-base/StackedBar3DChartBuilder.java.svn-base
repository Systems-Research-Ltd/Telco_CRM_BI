...
public class StackedBar3DChartBuilder {
...
/*		GroupBuilder gb2 = new GroupBuilder(); 
	...
	public void createStackedBar3D(AbstractColumn pc, List<AbstractColumn> aa, DynamicReportBuilder drb){
	...
	*/
	public static void main(String[] args) throws Exception {
		StackedBar3DChartBuilder test = new StackedBar3DChartBuilder();
		test.setUp();
		//test.testReport();
