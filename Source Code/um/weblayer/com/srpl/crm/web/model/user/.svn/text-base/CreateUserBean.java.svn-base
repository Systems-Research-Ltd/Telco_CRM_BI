...
public class CreateUserBean implements Serializable {
	...
	private List<UmFranchise>franchiseList;
...
//		try {
	...
	public void franchiseUser(){
		franchiseList=new ArrayList<UmFranchise>();
	}
		
		
	public List<UmFranchise> getFranchiseList() {
		return franchiseList;
	}

	public void setFranchiseList(List<UmFranchise> franchiseList) {
