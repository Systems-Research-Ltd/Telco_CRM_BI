...
public class Bar3DChartBuilder {
	...
	public void create3DBarChart(List<AbstractColumn> xAxis, List<AbstractColumn> yAxis,
		...
		cb.setX(20)
				...
				//.setCategory((PropertyColumn) xAxis.get(1))
				// .addSerie(aa.get(0))
				// .addSerie(aa.get(1))
				// plot
				.setXOffset(10).setyOffset(10).setShowLabels(false)
				.setCategoryAxisFormat(categoryAxisFormat)
				.setValueAxisFormat(valueAxisFormat);

		for (AbstractColumn a1 : yAxis) {
			cb.addSerie(a1);
		}
	...
	public static void main(String[] args) throws Exception {
		Bar3DChartBuilder test = new Bar3DChartBuilder();
