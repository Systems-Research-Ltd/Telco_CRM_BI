...
public class Address extends JSFBeanSupport implements Serializable
{
	...
	public Address()
	{
		if(util == null){
			...
			try {
				...
				util = (UtilsDAO) ctx.lookup("java:global/srpl/crm_businesslayer/UtilsDAO");
	...
	public void stateAL(String id){
		System.out.println(id);
		stateAL(Integer.parseInt(id));
	}
	public void stateAL(int id){
		...
		if(stateList.size() == 0){
			com.srpl.crm.web.model.common.State e = new com.srpl.crm.web.model.common.State(-1,0,"Select Country First","SCF");
			stateList.add(e);
		}
		cityAL(0);
	}
	...
	public void cityAL(String id){
		System.out.println(id);
		cityAL(Integer.parseInt(id));
	}
	public void cityAL(int id){
		...
		if(cityList.size() == 0){
			com.srpl.crm.web.model.common.City e = new com.srpl.crm.web.model.common.City(-1,0,"Select State First");
			cityList.add(e);
		}
	}
