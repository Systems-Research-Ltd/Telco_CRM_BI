...
public class ImageServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
		...
		SessionDataBean session = (SessionDataBean) request.getSession().getAttribute("sessionDataBean");
		String path = "";
		String module = request.getParameter("mod");
		String imagePath = getServletContext().getRealPath("");
		String application = session.getSelectedApplication();
		//System.out.println("Selected application ......"+session.getSelectedApplication());
		System.out.println();
		...
		imagePath += path;
		System.out.println("Path in servlet is.................. "+imagePath);
