...
public class PrivilegeBackingBean extends JSFBeanSupport implements
	...
	public void setFeaturesPermissionsList(List<GroupPermission> featuresPermissionsList) {
	...
	public void applyChanges() {
		...
		addMessage("Privileges Set Successfully!");
	...
	public void selectedCheckBox(){
		...
		if(featuresPermissionsList!=null){
			...
			permissionCode = getPermission().getPermissionCode(Integer.parseInt(permissionCode+""), hor);
			...
			System.out.println(groupPermission.getPermissionService().getServiceName());
