...
//
	public static void exportReportDoc(JasperPrint jp, String path) throws JRException, FileNotFoundException{
		...
		exporter.setParameter(JRDocxExporterParameter.JASPER_PRINT, jp);
		exporter.setParameter(JRDocxExporterParameter.OUTPUT_STREAM, fos);
		...
		logger.debug("DOC Report exported: " + path);
	}
}
